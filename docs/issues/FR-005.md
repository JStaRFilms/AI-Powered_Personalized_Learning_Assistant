...
## Acceptance Criteria
- [ ] The user can send a message in a clean, responsive chat UI.
- [ ] The backend retrieves relevant context from the database for the query.
- [ ] The AI responds strictly based on the retrieved context, streaming the answer back to the UI.
- [ ] Past messages in the current session are visible.
